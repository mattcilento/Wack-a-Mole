...
function showAndHide(hole, delay) {
  toggleVisibility(hole); // Show the mole initially

  var timeoutID = setTimeout(function () {
    toggleVisibility(hole); // Hide the mole after the delay
    gameOver();
    showUp(); // Call showUp again to show another mole
  }, delay);
  return timeoutID;
}
...
function showUp() {
  var delay = setDelay(difficulty); // Call setDelay() to get the desired delay value
  var hole = chooseHole(holes); // Call chooseHole() to get the desired hole
  return showAndHide(hole, delay); // Call showAndHide() with the hole and delay values
